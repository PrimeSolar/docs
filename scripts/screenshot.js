/**
 * Script for Downloading a Webpage as an Image
 *
 * Capture a screenshot of the current page and download it as an image.
 *
 * Dynamically loads the script and appends it to a webpage,
 * applies visual and layout styles suitable for printing of various element groups,
 * renders document.body to a canvas, converts the canvas to a JPEG data URL,
 * creates an anchor with the data URL and a download attribute with the filename,
 * programmatically clicks it to trigger the file download,
 * and applies the original visual and layout styles to the element groups.
 *
